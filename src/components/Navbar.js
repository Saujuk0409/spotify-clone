...
function Navbar({showSearch}) {
  ...
  return (
    <>
    <div style={{display:"flex",marginLeft:"40px",marginTop:"10px",padding:"0px",backgroundColor:"black",height:"100%"}}>
    ...
    <div className="topNavBar" style={{width:"100%",height:"100px",display:"flex"}}>
